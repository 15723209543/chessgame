...
// 设置页第一行按钮纵坐标。
inline constexpr int map_setup_first_button_y = 278;

// 设置页每一项之间的纵向间距。
inline constexpr int map_setup_row_gap = 68;

// 设置页按钮上方标题偏移量。
inline constexpr int map_setup_label_offset = 26;
...
// 游戏结束时重新开始按钮纵坐标。
inline constexpr int map_game_over_restart_y = 720;
