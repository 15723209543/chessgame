...
export function zhongguoxiangqi_create_game({ boardHost: zhongguoxiangqi_board_host, controlsHost: zhongguoxiangqi_controls_host, savedState: zhongguoxiangqi_saved_state, setting: zhongguoxiangqi_setting, services: zhongguoxiangqi_services }) {
  ...
  function zhongguoxiangqi_draw() {
    ...
    const zhongguoxiangqi_legal_targets = zhongguoxiangqi_selected === null ? [] : zhongguoxiangqi_legal_moves(zhongguoxiangqi_state.board, zhongguoxiangqi_state.side).filter(zhongguoxiangqi_move => zhongguoxiangqi_move.from === zhongguoxiangqi_selected).map(zhongguoxiangqi_move => zhongguoxiangqi_move.to); // zhongguoxiangqi_legal_targets：选中棋子的合法目标下标。
    const zhongguoxiangqi_capture_targets = zhongguoxiangqi_legal_targets.filter(zhongguoxiangqi_target => Boolean(zhongguoxiangqi_state.board[zhongguoxiangqi_target])); // zhongguoxiangqi_capture_targets：需要在目标棋子外补画绿色轮廓的吃子位置。
    for (const zhongguoxiangqi_target of zhongguoxiangqi_legal_targets) { if (zhongguoxiangqi_state.board[zhongguoxiangqi_target]) continue; const zhongguoxiangqi_row = Math.floor(zhongguoxiangqi_target / 9); const zhongguoxiangqi_col = zhongguoxiangqi_target % 9; zhongguoxiangqi_context.beginPath(); zhongguoxiangqi_context.arc(zhongguoxiangqi_left + zhongguoxiangqi_col * zhongguoxiangqi_step_x, zhongguoxiangqi_top + zhongguoxiangqi_row * zhongguoxiangqi_step_y, 8, 0, Math.PI * 2); zhongguoxiangqi_context.fillStyle = "rgba(28,114,83,.62)"; zhongguoxiangqi_context.fill(); }
    for (let zhongguoxiangqi_square = 0; zhongguoxiangqi_square < 90; zhongguoxiangqi_square += 1) {
    ...
    for (const zhongguoxiangqi_target of zhongguoxiangqi_capture_targets) { const zhongguoxiangqi_row = Math.floor(zhongguoxiangqi_target / 9); const zhongguoxiangqi_col = zhongguoxiangqi_target % 9; zhongguoxiangqi_context.beginPath(); zhongguoxiangqi_context.arc(zhongguoxiangqi_left + zhongguoxiangqi_col * zhongguoxiangqi_step_x, zhongguoxiangqi_top + zhongguoxiangqi_row * zhongguoxiangqi_step_y, 27, 0, Math.PI * 2); zhongguoxiangqi_context.strokeStyle = "rgb(36,130,94)"; zhongguoxiangqi_context.lineWidth = 4; zhongguoxiangqi_context.stroke(); }
